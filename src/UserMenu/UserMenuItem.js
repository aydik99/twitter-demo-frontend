...
class UserMenuItem extends Component {
  render () {
    return (
      <NavLink to={this.props.src}>
        <UserBlockItem className={this.props.active == 1 ? 'active' : null}>
          <UserBlockItemName>{this.props.name}</UserBlockItemName>
          <UserBlockItemCount>{this.props.count}</UserBlockItemCount>
        </UserBlockItem>
      </NavLink>
    )
  }
